...
/*
        ...
        Function<Person, String> personDescription = p -> {
        ...
        System.out.println(storage.findOneAndMapToString(findID456, personDescription));
*/
...
/*
        Predicate<Person> findMale = person -> person.getGender().equals(Gender.MALE);
        ...
        storage.findManyAndMapEachToString(findMale.and(startsWithE), toString).forEach(System.out::println);
*/
    ...
    public static void exercise10(String message) {
        System.out.println(message);
/*
        Consumer<Person> printFullName = person -> System.out.println("Name: " + person.getFirstName() + " " +
                person.getLastName());

        Predicate<Person> findPalindrome = p -> {
            StringBuilder stringBuilder = new StringBuilder(p.getFirstName().toLowerCase());
            stringBuilder.reverse();

            return p.getFirstName().toLowerCase().equals(stringBuilder.toString());
        };

        storage.findAndDo(findPalindrome, printFullName);
*/
        storage.findAndDo(
